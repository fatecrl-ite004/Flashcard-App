...
Detailed functional requirements belong in the system specification. Technical organization and implementation decisions belong in the [ Architecture documentation ](./docs/architecture/README.md) and [ Architecture Decision Records documentation ](./docs/adr/README.md).
